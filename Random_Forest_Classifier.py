...
rclf=RandomForestClassifier(n_estimators=10,bootstrap=True)

clf = make_pipeline(preprocessing.StandardScaler(),rclf) # Chain a preprocesing step with the Classifier
